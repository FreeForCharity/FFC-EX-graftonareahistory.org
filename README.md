# FFC-EX-graftonareahistory.org

Grafton Historical Society — FFC-supported charity website (static, GitHub Pages).

This repository holds a fully localized static capture of the former WordPress site at
`graftonareahistory.org`, migrated as part of the FFC Wave-1 WordPress-to-Pages program
...
- Deployed to GitHub Pages on the default URL:
  <https://freeforcharity.github.io/FFC-EX-graftonareahistory.org/>
...
- Migrated from a WordPress site (Bublitz Creative build). Four YouTube video embeds are retained (external, allowed by design).
